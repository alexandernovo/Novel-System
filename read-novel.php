...
<div class="container my-3 text-white">
    <div class="col-9 mx-auto ">
        ...
        <div class="d-flex justify-content-center">
            <a href="publish_view.php?id=<?php echo $_GET['novel_id'] ?>" class="btn btn-secondary btn-sm px-4 button-teal"><i class="fa fa-home"></i> Home</a>
        </div>
        ...
        <div class="row mx-auto mb-5">
            <div class="d-flex justify-content-end">
                ...
                <?php if ($chapter1['chapter_number'] != $chapter['chapter_number']) : ?>
                    <?php if ($chapterprev) : ?>
                        <a href="read-novel.php?chapter_id=<?= $chapterprev['chapter_id'] ?>&novel_id=<?php echo $_GET['novel_id'] ?>" class="btn btn-primary px-4 me-2 button-teal"><i class="fa fa-angle-left text-bold"></i> Prev</a>
                    <?php endif; ?>
                <?php endif; ?>

                <?php if ($chapternext) : ?>
                    <a href="read-novel.php?chapter_id=<?= $chapternext['chapter_id'] ?>&novel_id=<?php echo $_GET['novel_id'] ?>" class="btn btn-primary px-4 button-teal">Next <i class="fa fa-angle-right text-bold"></i></a>
                <?php endif; ?>
