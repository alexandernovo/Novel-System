...
<div class="container my-3">
    <div class="d-flex justify-content-end">
        <a href="editor-dashboard.php" class="btn btn-secondary btn-sm px-4"><i class="fa fa-arrow-left"></i> Back</a>
    </div>
        ...
        <div class="col-12 mb-3">
            ...
            <div class="row mx-auto g-0">
                ...
                <div class="col-6">
                    <div class="row mx-auto ms-1">
                        ...
                        <a href="<?php echo $first ? 'read-novel.php?chapter_id=' . $first['chapter_id'] . '&novel_id=' . $_GET['view'] : '#' ?>" class="btn btn-primary mb-2 btn-sm"><i class="fa fa-book"></i> Read Last</a>
                    </div>
                </div>
            </div>
            <?php if ($novel['status'] != 'PUBLISHED') : ?>
                <div class="row mx-auto g-0">
                    <div class="col-6">
                        <div class="row mx-auto me-1">
                            <a href="comments.php?deny=<?php echo $_GET['view'] ?>" class="btn btn-danger me-2 btn-sm"><i class="fa fa-history"></i> Needs Revision</a>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="row mx-auto ms-1">
                            <a href="novel-action.php?approve=<?php echo $_GET['view'] ?>" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Request for Approval</a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
